...
Add Intel SGX support on branch sgx
...
If you want to build SGX version switch to sgx branch, then use CMakeLists.txt to generate trused version lib `libtprotobuf-c.a`.
